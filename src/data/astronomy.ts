...
{ id:'hr',title:'דיאגרמת H–R',icon:'⌁',controls:'בחירה וגרירה של כוכב',result:'מיקום בדיאגרמה, צבע וגודל',available:true },
...
{question:'באיזה כיוון נמצאים הכוכבים החמים יותר בדיאגרמת H–R?',options:['ימינה','שמאלה','למטה בלבד'],answer:1,explanation:'הטמפרטורה עולה שמאלה. הציר האנכי מציג הארה, ולא טמפרטורה.'},
{question:'לכוכב טמפרטורה גבוהה אך הארה נמוכה. מה אפשר להסיק על גודלו?',options:['הוא חייב להיות גדול מאוד','הוא קטן יחסית; כך מתנהגים ננסים לבנים','אי אפשר לקשר בין הארה לרדיוס'],answer:1,explanation:'לפי L = 4πR²σT⁴, טמפרטורה גבוהה עם הספק כולל נמוך מחייבת שטח פנים קטן.'},
{question:'באותה טמפרטורה, הכפלנו את רדיוס הכוכב. מה קורה להארה?',options:['גדלה פי 2','נשארת קבועה','גדלה פי 4'],answer:2,explanation:'בטמפרטורה קבועה ההארה יחסית לשטח הפנים, ולכן לרדיוס בריבוע.'}
];
