...
type Route='optics'|'astronomy'|'star-formation'|'black-hole';
const routes:Route[]=['optics','astronomy','star-formation','black-hole'];
...
export default function App() {
  ...
  useEffect(()=>{document.title=({'optics':'מראה מישורית','astronomy':'אסטרונומיה','star-formation':'היווצרות כוכב','black-hole':'היווצרות חור שחור'}[route])+' | מעבדת פיזיקה'},[route]);
