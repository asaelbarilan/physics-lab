...
const EnergyLabs=lazy(()=>import('./simulations/energy/EnergyLabs'));
type Route='optics'|'astronomy'|'star-formation'|'black-hole'|'hr'|'energy';
const routes:Route[]=['optics','astronomy','star-formation','black-hole','hr','energy'];
